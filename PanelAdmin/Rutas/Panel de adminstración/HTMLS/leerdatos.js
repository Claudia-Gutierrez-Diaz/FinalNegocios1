...
function crudCat(argument) {
	let cats=[{"Id":"1","Nombre":"Todos los productos"},{"Id":"2","Nombre":" ARTÍCULOS PARA FIESTAS"},{"Id":"3","Nombre":" PASTELES"}, {"Id":"4","Nombre":"DULCES"}];
	...
	btnEditar.classList.add("btn-warning");
	btnEditar.onclick = function(){ 
		let nuevoId= prompt("Id: ",cell1.innerHTML); 
		let nuevaCategoria= prompt("Nombre de la categoría: ",cell2.innerHTML); 
		cell1.innerHTML = nuevoId;
		cell2.innerHTML = nuevaCategoria;
	}
	cell4.appendChild(btnEditar); 
	});
